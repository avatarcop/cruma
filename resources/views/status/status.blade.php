      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <!-- <a class="btn btn-primary" href="{{url('status/create')}}">Create Status</a> -->
            <!-- <br><br> -->
...
@endforeach
          ...
          <table class="table table-striped table-bordered dataTable" id="datastatus" style="color:#636362">
              <thead>
              <tr>
                  <th class="dt-head-center">Status Code</th>
                  <th class="dt-head-center">Status Name</th>
              ...
              <tbody>
                @foreach($status as $row)
                    <tr>
                        ...
                        <!-- <td align="center">
                        <a class="btn btn-primary" href="{{ url('status/edit') }}/{{ $row->id }}">Edit</a> 
                        <a onclick="return KonfirmasiDelete()" href="{{url('status/delete')}}/{{$row->id}}" type="submit" class="btn btn-danger">Delete</a>
                        </td> -->
                    </tr>
                @endforeach
...
<script type="text/javascript"> //reload page ajax
  ...
  $(document).ready(function () {
      var table = $('#datastatus').DataTable({
      ...
      $('#datastatus tfoot th').each(function () {
          var title = $(this).text();
