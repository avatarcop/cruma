      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form id="FormIni" method="POST" action="{{url('project/store')}}">
                  {{ csrf_field() }}
            <table class="table">
              ...
              <tr>
                ...
                <td> 
                  <input style="width: 200px;" maxlength="3" type="text" name="project_code" class="form-control"> 
                </td>
              </tr>
              ...
              <tr>
                ...
                <td> 
                  <input style="width: 200px;" maxlength="20" type="text" name="project_name" class="form-control"> 
                </td>
              </tr>
...
$(document).ready(function() {
  ...
  $('#FormIni').validate({
    rules: {
     ...
     messages: {
        project_code : {
          remote: "Project code already taken."
        } 
