                    ...
                    <tr>
                        ...
                        <td align="center">
                          @if($row->urgency->urgency_name == 'High')
                            <a onclick="return KonfirmasiTake()" href="{{url('scrum/take')}}/{{$row->id}}" type="submit" class="btn btn-danger">Take</a>
                          @elseif($row->urgency->urgency_name == 'Medium')
                            <a onclick="return KonfirmasiTake()" href="{{url('scrum/take')}}/{{$row->id}}" type="submit" class="btn btn-warning">Take</a>
                          @else
                            <a onclick="return KonfirmasiTake()" href="{{url('scrum/take')}}/{{$row->id}}" type="submit" class="btn btn-primary">Take</a>
                          @endif
