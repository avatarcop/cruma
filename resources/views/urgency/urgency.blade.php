      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <!-- <a class="btn btn-primary" href="{{ url('urgency/create') }}">Create Urgency</a> -->
            <br><br>
          ...
          <table class="table table-striped table-bordered dataTable" id="dataurgency" style="color:#636362">
              <thead>
              <tr>
                  <th class="dt-head-center">Urgency Name</th>
              ...
              <tbody>
                @foreach($urgency as $row)
                    <tr>
                        <td>{{ $row->urgency_name }}</td>
                        <td>{{ $row->created_at }}</td>

                        <!-- <td align="center">
                        <a class="btn btn-primary" href="{{ url('urgency/edit') }}/{{ $row->id }}">Edit</a> 
                        <a onclick="return KonfirmasiDelete()" class="btn btn-danger" href="{{ url('urgency/delete') }}/{{ $row->id }}">Delete</a>
                        </td> -->
                    </tr>
                @endforeach
...
<script type="text/javascript"> //reload page ajax
  ...
  $(document).ready(function () {
      var table = $('#dataurgency').DataTable({
      ...
      $('#dataurgency tfoot th').each(function () {
          var title = $(this).text();
