      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <a class="btn btn-primary" href="{{url('client/create')}}">Create Client</a>
            <br><br>
          ...
          <table class="table table-striped table-bordered dataTable" id="dataclient" style="color:#636362">
              <thead>
              <tr>
                  <th class="dt-head-center">Client Code</th>
                  <th class="dt-head-center">Client Name</th>
              ...
              <tbody>
                @foreach($client as $row)
                    <tr>
                        ...
                        <td align="center">
                        <a style="width: 70px;" class="btn btn-primary" href="{{ url('client/edit') }}/{{ $row->id }}">Edit</a> 
                        <a onclick="return KonfirmasiDelete()" href="{{url('client/delete')}}/{{$row->id}}" type="submit" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                @endforeach
...
<script type="text/javascript"> //reload page ajax
  ...
  $(document).ready(function () {
      var table = $('#dataclient').DataTable({
      ...
      $('#dataclient tfoot th').each(function () {
          var title = $(this).text();
