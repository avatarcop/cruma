      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form id="FormIni" method="POST" enctype="multipart/form-data" action="{{url('staff/update')}}/{{ $edit->id }}">
                  {{ csrf_field() }}
            ...
            <table class="table">
              ...
              <tr>
                ...
                <td> 
                  <input readonly="" style="width: 200px;" type="text" name="staff_code" class="form-control" value="{{ $edit->staff_code }}"> 
                </td>
              </tr>
              ...
              <tr>
                ...
                <td> 
                  <input style="width: 200px;" type="text" name="staff_name" class="form-control" value="{{ $edit->staff_name }}"> 
                </td>
              </tr>
              ...
              <tr>
                ...
                <td> 
                  <input style="width: 200px;" type="text" name="email" class="form-control" value="{{ $edit->user->email or ''}}"> 
                </td>
              </tr>
              ...
              <tr>
                ...
                <td> 
                  <input style="width: 200px;" type="password" name="password" class="form-control" value="{{ $edit->user->password or '' }}"> 
                </td>
              </tr>
              ...
              <tr>
                ...
                <td> 
                  <select style="width: 350px;" class="form-control" name="role_id" id="role_id" onchange="staffrole(this.value)">
                      <option value="" selected="">Select Staff Role</option>
                      @foreach($staffrole as $row)
                        @if($row->id == $edit->user->role_id or '')
              ...
              <tr>
                ...
                <td> 
                  <input style="width: auto;" type="file" name="avatar" class="form-control"> 
                </td>
              </tr>
