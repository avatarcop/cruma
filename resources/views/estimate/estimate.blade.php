      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <!-- <a class="btn btn-primary" href="{{url('estimate/create')}}">Create Estimate</a> -->
            <br><br>
          ...
          <table class="table table-striped table-bordered dataTable" id="dataestimate" style="color:#636362">
              <thead>
              <tr>
                  <th class="dt-head-center">Estimate Hour</th>
                  <th class="dt-head-center">Desc</th>
              ...
              <tbody>
                @foreach($estimate as $row)
                    <tr>
                        ...
                        <!-- <td align="center">
                        <a class="btn btn-primary" href="{{ url('estimate/edit') }}/{{ $row->id }}">Edit</a> 
                        <a onclick="return KonfirmasiDelete()" href="{{url('estimate/delete')}}/{{$row->id}}" type="submit" class="btn btn-danger">Delete</a>
                        </td> -->
                    </tr>
                @endforeach
...
<script type="text/javascript"> //reload page ajax
  ...
  $(document).ready(function () {
      var table = $('#dataestimate').DataTable({
      ...
      $('#dataestimate tfoot th').each(function () {
          var title = $(this).text();
