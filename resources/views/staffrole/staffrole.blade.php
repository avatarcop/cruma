      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <a class="btn btn-primary"  href="{{url('staffrole/create')}}">Create Staff Role</a>
            <br><br>
          ...
          <table class="table table-striped table-bordered dataTable" id="datastaffrole" style="color:#636362">
              <thead>
              <tr>
                  <th class="dt-head-center">Role Code</th>
                  <th class="dt-head-center">Role Name</th>
              ...
              <tbody>
                @foreach($staffrole as $row)
                    <tr>
                        ...
                        <td align="center">
                        <a class="btn btn-primary" href="{{ url('staffrole/edit') }}/{{ $row->id }}">Edit</a> 
                        <a onclick="return KonfirmasiDelete()" href="{{url('staffrole/delete')}}/{{$row->id}}" type="submit" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                @endforeach
...
<script type="text/javascript"> //reload page ajax
  ...
  $(document).ready(function () {
      var table = $('#datastaffrole').DataTable({
      ...
      $('#datastaffrole tfoot th').each(function () {
          var title = $(this).text();
