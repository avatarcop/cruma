      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form id="FormIni"  method="POST" action="{{url('staffrole/update')}}/{{ $edit->id }}">
                  {{ csrf_field() }}
            <table class="table">
              ...
              <tr>
                ...
                <td> 
                  <input style="width: 200px;" readonly="readonly" type="text" name="role_code" class="form-control" value="{{ $edit->role_code }}"> 
                </td>
              </tr>
              ...
              <tr>
                <td>Role Name </td>
                <td> 
                  <input style="width: 200px;" type="text" maxlength="10" name="role_name" class="form-control" value="{{ $edit->role_name }}"> 
                </td>
              </tr>
...
function checkclass(data)
    ...
    @foreach (json_decode($edit->route_access_list)->routelist as $listcheck)
